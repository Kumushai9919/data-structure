...
int main(){
    ...
    load_graph("/Users/kumushainazhimidinkyzy/Documents/Data Structure/10주차 BFS구현 인접 리스트/10주차 BFS구현 인접 리스트/graph.text");
    reset_visited();
    printf("BFS ==>");
    BFS(0);
    printf("\n");
